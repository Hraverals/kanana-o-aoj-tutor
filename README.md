...
본 프로젝트는 카카오의 국내 최초 통합 멀티모달 AI 모델인 [Kanana-o](https://omni.kanana.ai/)를 활용해보기 위해 구현한 코드 리뷰 크롬 확장 프로그램입니다. 이 프로젝트를 개발할 수 있었던 이유는 제가 Kanana-o의 베타 테스터에 선정되었기 때문입니다. (야호!! 카카오 선생님들 감사합니다 . . .)
<br>
...
<br>
개발 후기는 제 Velog에서 읽어보실 수 있습니다.

- [카카오 Kanana-o 베타 API로 AI 코딩 튜터 만들기 (1)](https://velog.io/@hraverals/카카오-Kanana-o-베타-API로-AI-코딩-튜터-만들기-1)
- [카카오 Kanana-o 베타 API로 AI 코딩 튜터 만들기 (2)](https://velog.io/@hraverals/카카오-Kanana-o-베타-API로-AI-코딩-튜터-만들기-2)
...
| **텍스트 및 오디오 응답** | Kanana-o 모델과 텍스트, 오디오 중 원하는 방식으로 소통할 수 있습니다.                |
...
| 모델         | 설명                                                 |
| ------------ | ---------------------------------------------------- |
| **Kanana-o** | 카카오클라우드 제공 멀티모달 AI 모델 (베타 버전 API) |
