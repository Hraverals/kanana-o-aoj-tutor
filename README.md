...
본 프로젝트는 카카오의 국내 최초 통합 멀티모달 AI 모델인 [Kanana-o](https://omni.kanana.ai/)를 활용해보기 위해 구현한 코드 리뷰 크롬 확장 프로그램입니다. 이 프로젝트를 개발할 수 있었던 이유는 제가 Kanana-o의 베타 테스터에 선정되었기 때문입니다. ~~야호!! 키카오 선생님들 감사합니다 . . .~~ 
<br>
